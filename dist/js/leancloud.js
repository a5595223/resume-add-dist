    ...
    loadMessages: function () {
      ...
      this.model.fetch().then(messages => {
        ...
        array.forEach(element => {
          ...
          this.messageList.insertBefore(li, this.messageList.childNodes[0]);
        });
      });
    },
    bindEvents: function () {
      ...
      myForm.addEventListener('submit', e => {
        console.log(1);
        e.preventDefault();
        this.saveMessage(myForm); // var content = myForm.querySelector('input[name = content]').value
...
}.call(); // document.querySelector('#postMessage').addEventListener('submit', function (e) {
//     e.preventDefault()
